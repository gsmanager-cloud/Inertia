 ...
 * @method static void share(string|array|\GSManager\Contracts\Support\Arrayable $key, mixed $value = null)
 ...
 * @method static \Inertia\Response render(string $component, array|\GSManager\Contracts\Support\Arrayable $props = [])
